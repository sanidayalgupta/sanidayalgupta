...
class Command(BaseCommand):
    ...
    def populate_basics(self, num_students):
        ...
        for title in course_titles:
            ...
            self.stdout.write(f'  [OK] Created course: {title}')
        ...
        for i in range(num_students):
            ...
            if i % 10 == 0:
                self.stdout.write(f'  [OK] Created {i+1} students...')
        
        self.stdout.write(self.style.SUCCESS(f'  [OK] Created {num_students} students and {len(courses)} courses'))
    ...
    def populate_intermediate(self, num_books):
        ...
        for i in range(20):
            ...
            if i % 5 == 0:
                self.stdout.write(f'  [OK] Created {i+1} authors...')
        ...
        for i in range(num_books):
            ...
            if i % 20 == 0:
                self.stdout.write(f'  [OK] Created {i+1} books...')
        
        self.stdout.write(self.style.SUCCESS(f'  [OK] Created {len(authors)} authors, {len(books)} books, and reviews'))
    ...
    def populate_advanced(self, num_blogposts):
        ...
        for i in range(num_blogposts):
            ...
            if i % 10 == 0:
                self.stdout.write(f'  [OK] Created {i+1} blog posts...')
        
        self.stdout.write(self.style.SUCCESS(f'  [OK] Created {len(users)} users, {len(blog_posts)} blog posts, and comments'))
    ...
    def populate_expert(self, num_companies):
        ...
        self.stdout.write(self.style.SUCCESS(
            f'  [OK] Created {len(companies)} companies, {Department.objects.count()} departments, '
